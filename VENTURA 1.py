...
opcion_inicio = input("que haces??: NOTA o ANTORCHA ").lower()
...
if opcion_inicio == "nota":
    ...
    opcion_trampa = input("que haces??: AGACHARTE o CORRER ").lower()
    if opcion_trampa == "agacharte":
        ...
        opcion_duda = input(" ACERCARSE o HACERSE MUERTO ").lower()
        if opcion_duda == "hacerse muerto":
            ...
            opcion_aldea = input("cual es tu siguiente movimiento: EXPLORAR o ESPERAR ")
